...
class C_sach{
	 public function trang_chu(){
	 	...
	 	$Smarty_ung_dung->display('trang_chu.html');
	 	//$m_sach->disconnect();
	 	
	 }
	 public function lien_he(){
	 	$Smarty_ung_dung= new Smarty_ung_dung();
	 	$Smarty_ung_dung->display('lien_he.html');
	 }
	 ...
	 public function tim_sach(){
    	...
    	$chuoi = explode('=',$pageURL);
	 	...
	 	$Smarty_ung_dung->display('sach/danh_sach_tim_kiem.html');	
	 	//$m_sach->disconnect();
	 }
	 ...
	 public function sach_theo_loai(){
	 	if(isset($_GET['ki_hieu'])){
			...
			$arr_sach->display('sach/sach_theo_loai.html');	
	 	}
	}
	...
	public function them_san_pham(){
        ...
        $Smarty_ung_dung->display('admin/them_san_pham.html');
        //$m_sach->disconnect();
	}
	...
	public function sua_san_pham(){
        ...
        if (isset($_POST['submit']) && isset($_POST['ten_sach_auto'])){
	        	...
	        	$Smarty_ung_dung->display('admin/sua_san_pham.html');
	...
	public function xoa_san_pham(){
        ...
        if (isset($_POST['submit']) && isset($_POST['ten_sach_auto'])){
				...
				$Smarty_ung_dung->assign('tac_gia',$tac_gia);
				$Smarty_ung_dung->assign('nxb',$nxb);
				$Smarty_ung_dung->display('admin/xoa_san_pham.html');
    			}
	...
	public function chi_tiet_sach(){
			...
			$arr_sach->display('sach/chi_tiet_sach.html');	
	}
}
