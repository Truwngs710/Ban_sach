...
class C_khach_hang{
     ...
     public function thongTinGioHang(){
        ...
        if($shoppingcart->layGioHang()){
            ...
            $Smarty_ung_dung->display('khach_hang/v_gio_hang.html');
        }
        else $Smarty_ung_dung->display('khach_hang/v_gio_hang.html');
     }
        ...
        if(isset($_POST['submit']))
        {
            ...
            $data=array(
               ...
               // $shoppingcart->xoaGioHang();  
                ...
                $Smarty_ung_dung->display('khach_hang/v_dat_hang.html');

        }
        $Smarty_ung_dung->assign('data',$data);
        $Smarty_ung_dung->display('khach_hang/v_thong_tin_don_dat_hang.html');
